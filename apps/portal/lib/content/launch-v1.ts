...
// All routes that must exist
export const REQUIRED_ROUTES = [
  `${TECHPACK_BASE}/cover`,
  `${TECHPACK_BASE}/execution-rules`,
  `${TECHPACK_BASE}/brand-intent`,
  `${TECHPACK_BASE}/collection-overview`,
  ...allSkus.map(getSkuRoute),
  `${TECHPACK_BASE}/appendix-a-trims`,
  `${TECHPACK_BASE}/appendix-b-measurements/tees`,
  `${TECHPACK_BASE}/appendix-b-measurements/fleece`,
  `${TECHPACK_BASE}/appendix-b-measurements/swim-men`,
  `${TECHPACK_BASE}/appendix-b-measurements/coastal-women`,
  `${TECHPACK_BASE}/appendix-c-sku-construction`,
  `${TECHPACK_BASE}/final-lock-points`,
];
