import type { TechPackData, SkuGroup } from '@repo/types';
...
export function getSkuRoute(sku: TechPackData): string {
  return `/pack/launch-v1/${sku.collectionSlug}/${sku.slug}`;
}
...
// All routes that must exist — used by the validation script
export const REQUIRED_ROUTES = [
  '/pack/launch-v1/cover',
  '/pack/launch-v1/execution-rules',
  '/pack/launch-v1/brand-intent',
  '/pack/launch-v1/collection-overview',
  ...allSkus.map(getSkuRoute),
  '/pack/launch-v1/appendix-a-trims',
  '/pack/launch-v1/appendix-b-measurements/tees',
  '/pack/launch-v1/appendix-b-measurements/fleece',
  '/pack/launch-v1/appendix-b-measurements/swim-men',
  '/pack/launch-v1/appendix-b-measurements/coastal-women',
  '/pack/launch-v1/appendix-c-sku-construction',
  '/pack/launch-v1/final-lock-points',
];
